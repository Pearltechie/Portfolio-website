    ...
    <section id="about" ref={ref} className="relative py-32 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          >
            ...
            <motion.div
              ...
              className="mt-10 p-6 rounded-2xl bg-card-bg border border-card-border gradient-border"
            >
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-foreground/60">University of the People (2025 - 2027)</p>
                <p className="text-sm text-foreground/50">Currently Pursuing</p>
              </div>
            </motion.div>
          </motion.div>
        ...
        <motion.div
          ...
          className="border-t border-card-border pt-12"
        >
          <h3 className="text-center text-sm text-foreground/50 uppercase tracking-widest mb-8">
          ...
          <div className="overflow-hidden">
            <div className="flex animate-marquee whitespace-nowrap">
              {[
                ...
                <div
                  key={i}
                  className="inline-flex items-center gap-3 px-8 py-4 rounded-full bg-gradient-to-r from-accent/10 to-accent-secondary/10 border border-accent/20 mx-4"
                >
                  <Award className="text-accent" size={20} />
